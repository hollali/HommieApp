          ...
          <View style={styles.section}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.chipsContainer}>
                {(["all", ...PROPERTY_TYPES.map((t) => t.value)] as const).map(
                  (type) => (
                    <TouchableOpacity
                      key={type}
                      style={[
                    ...
                    >
                      <Text
                        style={[
                          styles.chipText,
                          localFilters.selectedType === type &&
              ...
              <View style={styles.chipsContainer}>
                {["all", ...GHANA_REGIONS.map((r) => r.name)].map((region) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.chip,
                      localFilters.selectedRegion === region &&
                        styles.chipActive,
                    ]}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.halfWidth}>
                ...
                >
                  <Text style={styles.selectorText}>
                    {localFilters.minBathrooms === null
                      ? "Any"
                      : localFilters.minBathrooms}
                  </Text>
                  <Ionicons name="chevron-down" size={16} color="#666" />
            ...
            <View style={styles.row}>
              <TouchableOpacity
                ...
                onPress={() =>
                  updateFilter(
                    "hasParking",
                    localFilters.hasParking === true ? null : true,
                  )
                }
              >
                <Ionicons
                ...
                <Text
                  style={[
                    ...
                    localFilters.hasParking === true &&
                      styles.featureChipTextActive,
                  ]}
                >
                  Parking
                </Text>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  updateFilter(
                    "furnished",
                    localFilters.furnished === true ? null : true,
                  )
                }
              >
                <Ionicons
            ...
            <View style={styles.amenitiesGrid}>
              {AMENITIES.slice(0, 12).map((amenity) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.amenityChip,
                    localFilters.selectedAmenities.includes(amenity) &&
